...
/**
 * Gets or Sets ReplicaMode
 */
@JsonAdapter(ReplicaMode.Adapter.class)
public enum ReplicaMode {
  ...
  public static ReplicaMode fromValue(String value) {
    for (ReplicaMode b : ReplicaMode.values()) {
  ...
  public static class Adapter extends TypeAdapter<ReplicaMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final ReplicaMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ReplicaMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ReplicaMode.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ReplicaMode.fromValue(value);
  }
}
