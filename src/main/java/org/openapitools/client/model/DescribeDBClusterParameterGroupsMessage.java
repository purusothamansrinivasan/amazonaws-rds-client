...
public class DescribeDBClusterParameterGroupsMessage {
  ...
  public DescribeDBClusterParameterGroupsMessage dbClusterParameterGroupName(@javax.annotation.Nullable String dbClusterParameterGroupName) {
  ...
  public DescribeDBClusterParameterGroupsMessage filters(@javax.annotation.Nullable List<Filter> filters) {
    this.filters = filters;
    return this;
  }

  public DescribeDBClusterParameterGroupsMessage addFiltersItem(Filter filtersItem) {
  ...
  public DescribeDBClusterParameterGroupsMessage maxRecords(@javax.annotation.Nullable Integer maxRecords) {
  ...
  public DescribeDBClusterParameterGroupsMessage marker(@javax.annotation.Nullable String marker) {
    this.marker = marker;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("DBClusterParameterGroupName", "Filters", "MaxRecords", "Marker"));
