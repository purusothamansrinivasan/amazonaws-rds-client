...
/**
 * Gets or Sets ExportSourceType
 */
@JsonAdapter(ExportSourceType.Adapter.class)
public enum ExportSourceType {
  ...
  public static ExportSourceType fromValue(String value) {
    for (ExportSourceType b : ExportSourceType.values()) {
  ...
  public static class Adapter extends TypeAdapter<ExportSourceType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ExportSourceType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ExportSourceType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ExportSourceType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ExportSourceType.fromValue(value);
  }
}
