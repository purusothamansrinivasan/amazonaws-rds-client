...
/**
 * Gets or Sets DBProxyEndpointStatus
 */
@JsonAdapter(DBProxyEndpointStatus.Adapter.class)
public enum DBProxyEndpointStatus {
  ...
  DBProxyEndpointStatus(String value) {
    this.value = value;
  }
  ...
  public static DBProxyEndpointStatus fromValue(String value) {
    for (DBProxyEndpointStatus b : DBProxyEndpointStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<DBProxyEndpointStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final DBProxyEndpointStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public DBProxyEndpointStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return DBProxyEndpointStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    DBProxyEndpointStatus.fromValue(value);
  }
}
