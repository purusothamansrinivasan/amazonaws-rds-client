...
public class RemoveTagsFromResourceMessage {
  ...
  public RemoveTagsFromResourceMessage resourceName(@javax.annotation.Nonnull String resourceName) {
  ...
  public RemoveTagsFromResourceMessage tagKeys(@javax.annotation.Nonnull List<String> tagKeys) {
    this.tagKeys = tagKeys;
    return this;
  }

  public RemoveTagsFromResourceMessage addTagKeysItem(String tagKeysItem) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("ResourceName", "TagKeys"));

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>(Arrays.asList("ResourceName", "TagKeys"));
  }
