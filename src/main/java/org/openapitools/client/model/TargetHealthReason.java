...
/**
 * Gets or Sets TargetHealthReason
 */
@JsonAdapter(TargetHealthReason.Adapter.class)
public enum TargetHealthReason {
  ...
  TargetHealthReason(String value) {
    this.value = value;
  }
  ...
  public static TargetHealthReason fromValue(String value) {
    for (TargetHealthReason b : TargetHealthReason.values()) {
  ...
  public static class Adapter extends TypeAdapter<TargetHealthReason> {
    @Override
    public void write(final JsonWriter jsonWriter, final TargetHealthReason enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public TargetHealthReason read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return TargetHealthReason.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    TargetHealthReason.fromValue(value);
  }
}
