...
public class DBInstanceRole {
  ...
  public DBInstanceRole roleArn(@javax.annotation.Nullable String roleArn) {
  ...
  public DBInstanceRole featureName(@javax.annotation.Nullable String featureName) {
    this.featureName = featureName;
    return this;
  }

  /**
   * The name of the feature associated with the Amazon Web Services Identity and Access Management (IAM) role. For information about supported feature names, see &lt;code&gt;DBEngineVersion&lt;/code&gt;.
   * @return featureName
   */
  @javax.annotation.Nullable
  ...
  public DBInstanceRole status(@javax.annotation.Nullable String status) {
    this.status = status;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DBInstanceRole dbInstanceRole = (DBInstanceRole) o;
    return Objects.equals(this.roleArn, dbInstanceRole.roleArn) &&
        Objects.equals(this.featureName, dbInstanceRole.featureName) &&
        Objects.equals(this.status, dbInstanceRole.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class DBInstanceRole {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("RoleArn", "FeatureName", "Status"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to DBInstanceRole
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DBInstanceRole.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DBInstanceRole is not found in the empty JSON string", DBInstanceRole.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DBInstanceRole.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DBInstanceRole` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DBInstanceRole.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DBInstanceRole' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DBInstanceRole> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DBInstanceRole.class));

       return (TypeAdapter<T>) new TypeAdapter<DBInstanceRole>() {
           @Override
           public void write(JsonWriter out, DBInstanceRole value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DBInstanceRole read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DBInstanceRole given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DBInstanceRole
   * @throws IOException if the JSON string is invalid with respect to DBInstanceRole
   */
  public static DBInstanceRole fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DBInstanceRole.class);
  }

  /**
   * Convert an instance of DBInstanceRole to an JSON string
   *
   * @return JSON string
   */
