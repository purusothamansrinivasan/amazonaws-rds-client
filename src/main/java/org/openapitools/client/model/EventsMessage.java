...
public class EventsMessage {
  ...
  public EventsMessage marker(@javax.annotation.Nullable String marker) {
    this.marker = marker;
    return this;
  }

  /**
   * An optional pagination token provided by a previous Events request. If this parameter is specified, the response includes only records beyond the marker, up to the value specified by &lt;code&gt;MaxRecords&lt;/code&gt;.
   * @return marker
   */
  @javax.annotation.Nullable
  ...
  public EventsMessage events(@javax.annotation.Nullable List<Event> events) {
    this.events = events;
    return this;
  }

  public EventsMessage addEventsItem(Event eventsItem) {
    if (this.events == null) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("Marker", "Events"));
