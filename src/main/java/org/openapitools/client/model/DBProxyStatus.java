...
/**
 * Gets or Sets DBProxyStatus
 */
@JsonAdapter(DBProxyStatus.Adapter.class)
public enum DBProxyStatus {
  ...
  public static DBProxyStatus fromValue(String value) {
    for (DBProxyStatus b : DBProxyStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<DBProxyStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final DBProxyStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public DBProxyStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return DBProxyStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    DBProxyStatus.fromValue(value);
  }
}
