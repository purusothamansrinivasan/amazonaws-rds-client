...
public class DescribeGlobalClustersMessage {
  ...
  public DescribeGlobalClustersMessage globalClusterIdentifier(@javax.annotation.Nullable String globalClusterIdentifier) {
  ...
  public DescribeGlobalClustersMessage filters(@javax.annotation.Nullable List<Filter> filters) {
    this.filters = filters;
    return this;
  }

  public DescribeGlobalClustersMessage addFiltersItem(Filter filtersItem) {
  ...
  public DescribeGlobalClustersMessage maxRecords(@javax.annotation.Nullable Integer maxRecords) {
  ...
  public DescribeGlobalClustersMessage marker(@javax.annotation.Nullable String marker) {
    this.marker = marker;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("GlobalClusterIdentifier", "Filters", "MaxRecords", "Marker"));
