...
public class IPRange {
  ...
  public IPRange status(@javax.annotation.Nullable String status) {
    this.status = status;
    return this;
  }
  ...
  public IPRange CIDRIP(@javax.annotation.Nullable String CIDRIP) {
    this.CIDRIP = CIDRIP;
    return this;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(status, CIDRIP);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("Status", "CIDRIP"));
