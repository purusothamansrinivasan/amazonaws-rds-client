...
/**
 * Gets or Sets LocalWriteForwardingStatus
 */
@JsonAdapter(LocalWriteForwardingStatus.Adapter.class)
public enum LocalWriteForwardingStatus {
  ...
  LocalWriteForwardingStatus(String value) {
    this.value = value;
  }
  ...
  public static LocalWriteForwardingStatus fromValue(String value) {
    for (LocalWriteForwardingStatus b : LocalWriteForwardingStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<LocalWriteForwardingStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final LocalWriteForwardingStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public LocalWriteForwardingStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return LocalWriteForwardingStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    LocalWriteForwardingStatus.fromValue(value);
  }
}
