...
/**
 * Gets or Sets ClientPasswordAuthType
 */
@JsonAdapter(ClientPasswordAuthType.Adapter.class)
public enum ClientPasswordAuthType {
  ...
  ClientPasswordAuthType(String value) {
    this.value = value;
  }
  ...
  public static ClientPasswordAuthType fromValue(String value) {
    for (ClientPasswordAuthType b : ClientPasswordAuthType.values()) {
  ...
  public static class Adapter extends TypeAdapter<ClientPasswordAuthType> {
    @Override
    public void write(final JsonWriter jsonWriter, final ClientPasswordAuthType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ClientPasswordAuthType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ClientPasswordAuthType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ClientPasswordAuthType.fromValue(value);
  }
}
