...
/**
 * Gets or Sets FailoverStatus
 */
@JsonAdapter(FailoverStatus.Adapter.class)
public enum FailoverStatus {
  ...
  public static FailoverStatus fromValue(String value) {
    for (FailoverStatus b : FailoverStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<FailoverStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final FailoverStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FailoverStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FailoverStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FailoverStatus.fromValue(value);
  }
}
