...
public class ScalingConfiguration {
  ...
  public ScalingConfiguration minCapacity(@javax.annotation.Nullable Integer minCapacity) {
  ...
  public ScalingConfiguration maxCapacity(@javax.annotation.Nullable Integer maxCapacity) {
  ...
  public ScalingConfiguration autoPause(@javax.annotation.Nullable Boolean autoPause) {
  ...
  public ScalingConfiguration secondsUntilAutoPause(@javax.annotation.Nullable Integer secondsUntilAutoPause) {
  ...
  public ScalingConfiguration timeoutAction(@javax.annotation.Nullable String timeoutAction) {
  ...
  public ScalingConfiguration secondsBeforeTimeout(@javax.annotation.Nullable Integer secondsBeforeTimeout) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.minCapacity, scalingConfiguration.minCapacity) &&
        Objects.equals(this.maxCapacity, scalingConfiguration.maxCapacity) &&
        Objects.equals(this.autoPause, scalingConfiguration.autoPause) &&
        Objects.equals(this.secondsUntilAutoPause, scalingConfiguration.secondsUntilAutoPause) &&
        Objects.equals(this.timeoutAction, scalingConfiguration.timeoutAction) &&
        Objects.equals(this.secondsBeforeTimeout, scalingConfiguration.secondsBeforeTimeout);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ScalingConfiguration
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ScalingConfiguration.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ScalingConfiguration is not found in the empty JSON string", ScalingConfiguration.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ScalingConfiguration.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ScalingConfiguration` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ScalingConfiguration.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ScalingConfiguration' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ScalingConfiguration> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ScalingConfiguration.class));

       return (TypeAdapter<T>) new TypeAdapter<ScalingConfiguration>() {
           @Override
           public void write(JsonWriter out, ScalingConfiguration value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ScalingConfiguration read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ScalingConfiguration given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ScalingConfiguration
   * @throws IOException if the JSON string is invalid with respect to ScalingConfiguration
   */
  public static ScalingConfiguration fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ScalingConfiguration.class);
  }

  /**
   * Convert an instance of ScalingConfiguration to an JSON string
   *
   * @return JSON string
   */
