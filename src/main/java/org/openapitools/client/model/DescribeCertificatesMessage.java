...
public class DescribeCertificatesMessage {
  ...
  public DescribeCertificatesMessage certificateIdentifier(@javax.annotation.Nullable String certificateIdentifier) {
  ...
  public DescribeCertificatesMessage filters(@javax.annotation.Nullable List<Filter> filters) {
    this.filters = filters;
    return this;
  }

  public DescribeCertificatesMessage addFiltersItem(Filter filtersItem) {
  ...
  public DescribeCertificatesMessage maxRecords(@javax.annotation.Nullable Integer maxRecords) {
  ...
  public DescribeCertificatesMessage marker(@javax.annotation.Nullable String marker) {
    this.marker = marker;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("CertificateIdentifier", "Filters", "MaxRecords", "Marker"));
