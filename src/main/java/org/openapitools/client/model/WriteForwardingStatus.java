...
/**
 * Gets or Sets WriteForwardingStatus
 */
@JsonAdapter(WriteForwardingStatus.Adapter.class)
public enum WriteForwardingStatus {
  ...
  WriteForwardingStatus(String value) {
    this.value = value;
  }
  ...
  public static WriteForwardingStatus fromValue(String value) {
    for (WriteForwardingStatus b : WriteForwardingStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<WriteForwardingStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final WriteForwardingStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public WriteForwardingStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return WriteForwardingStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    WriteForwardingStatus.fromValue(value);
  }
}
