 ...
 */
@JsonAdapter(TargetRole.Adapter.class)
public enum TargetRole {
  ...
  public static TargetRole fromValue(String value) {
    for (TargetRole b : TargetRole.values()) {
  ...
  public static class Adapter extends TypeAdapter<TargetRole> {
    @Override
    public void write(final JsonWriter jsonWriter, final TargetRole enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public TargetRole read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return TargetRole.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    TargetRole.fromValue(value);
  }
}
