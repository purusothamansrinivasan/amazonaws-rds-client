...
/**
 * Gets or Sets AutomationMode
 */
@JsonAdapter(AutomationMode.Adapter.class)
public enum AutomationMode {
  ...
  public static AutomationMode fromValue(String value) {
    for (AutomationMode b : AutomationMode.values()) {
  ...
  public static class Adapter extends TypeAdapter<AutomationMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final AutomationMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AutomationMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AutomationMode.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    AutomationMode.fromValue(value);
  }
}
