 ...
 */
@JsonAdapter(TargetState.Adapter.class)
public enum TargetState {
  ...
  public static class Adapter extends TypeAdapter<TargetState> {
    @Override
    public void write(final JsonWriter jsonWriter, final TargetState enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public TargetState read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return TargetState.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    TargetState.fromValue(value);
  }
}
