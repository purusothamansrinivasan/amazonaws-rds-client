...
/**
 * Gets or Sets AuditPolicyState
 */
@JsonAdapter(AuditPolicyState.Adapter.class)
public enum AuditPolicyState {
  ...
  public static AuditPolicyState fromValue(String value) {
    for (AuditPolicyState b : AuditPolicyState.values()) {
  ...
  public static class Adapter extends TypeAdapter<AuditPolicyState> {
    @Override
    public void write(final JsonWriter jsonWriter, final AuditPolicyState enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AuditPolicyState read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AuditPolicyState.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    AuditPolicyState.fromValue(value);
  }
}
