...
/**
 * Gets or Sets CustomEngineVersionStatus
 */
@JsonAdapter(CustomEngineVersionStatus.Adapter.class)
public enum CustomEngineVersionStatus {
  ...
  CustomEngineVersionStatus(String value) {
    this.value = value;
  }
  ...
  public static CustomEngineVersionStatus fromValue(String value) {
    for (CustomEngineVersionStatus b : CustomEngineVersionStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<CustomEngineVersionStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final CustomEngineVersionStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public CustomEngineVersionStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return CustomEngineVersionStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    CustomEngineVersionStatus.fromValue(value);
  }
}
