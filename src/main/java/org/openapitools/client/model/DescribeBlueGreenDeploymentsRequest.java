...
public class DescribeBlueGreenDeploymentsRequest {
  ...
  public DescribeBlueGreenDeploymentsRequest blueGreenDeploymentIdentifier(@javax.annotation.Nullable String blueGreenDeploymentIdentifier) {
  ...
  public DescribeBlueGreenDeploymentsRequest filters(@javax.annotation.Nullable List<Filter> filters) {
    this.filters = filters;
    return this;
  }

  public DescribeBlueGreenDeploymentsRequest addFiltersItem(Filter filtersItem) {
  ...
  public DescribeBlueGreenDeploymentsRequest marker(@javax.annotation.Nullable String marker) {
    this.marker = marker;
    return this;
  }

  /**
   * An optional pagination token provided by a previous &lt;code&gt;DescribeBlueGreenDeployments&lt;/code&gt; request. If you specify this parameter, the response only includes records beyond the marker, up to the value specified by &lt;code&gt;MaxRecords&lt;/code&gt;.
   * @return marker
   */
  @javax.annotation.Nullable
  ...
  public DescribeBlueGreenDeploymentsRequest maxRecords(@javax.annotation.Nullable Integer maxRecords) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.blueGreenDeploymentIdentifier, describeBlueGreenDeploymentsRequest.blueGreenDeploymentIdentifier) &&
        Objects.equals(this.filters, describeBlueGreenDeploymentsRequest.filters) &&
        Objects.equals(this.marker, describeBlueGreenDeploymentsRequest.marker) &&
        Objects.equals(this.maxRecords, describeBlueGreenDeploymentsRequest.maxRecords);
  }

  @Override
  public int hashCode() {
    return Objects.hash(blueGreenDeploymentIdentifier, filters, marker, maxRecords);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("BlueGreenDeploymentIdentifier", "Filters", "Marker", "MaxRecords"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeBlueGreenDeploymentsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeBlueGreenDeploymentsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeBlueGreenDeploymentsRequest is not found in the empty JSON string", DescribeBlueGreenDeploymentsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeBlueGreenDeploymentsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeBlueGreenDeploymentsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeBlueGreenDeploymentsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeBlueGreenDeploymentsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeBlueGreenDeploymentsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeBlueGreenDeploymentsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeBlueGreenDeploymentsRequest>() {
           @Override
           public void write(JsonWriter out, DescribeBlueGreenDeploymentsRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeBlueGreenDeploymentsRequest read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeBlueGreenDeploymentsRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeBlueGreenDeploymentsRequest
   * @throws IOException if the JSON string is invalid with respect to DescribeBlueGreenDeploymentsRequest
   */
  public static DescribeBlueGreenDeploymentsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeBlueGreenDeploymentsRequest.class);
  }

  /**
   * Convert an instance of DescribeBlueGreenDeploymentsRequest to an JSON string
   *
   * @return JSON string
   */
