...
public class DescribeDBInstancesMessage {
  ...
  public DescribeDBInstancesMessage dbInstanceIdentifier(@javax.annotation.Nullable String dbInstanceIdentifier) {
  ...
  public DescribeDBInstancesMessage filters(@javax.annotation.Nullable List<Filter> filters) {
    this.filters = filters;
    return this;
  }

  public DescribeDBInstancesMessage addFiltersItem(Filter filtersItem) {
  ...
  public DescribeDBInstancesMessage maxRecords(@javax.annotation.Nullable Integer maxRecords) {
  ...
  public DescribeDBInstancesMessage marker(@javax.annotation.Nullable String marker) {
    this.marker = marker;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("DBInstanceIdentifier", "Filters", "MaxRecords", "Marker"));
