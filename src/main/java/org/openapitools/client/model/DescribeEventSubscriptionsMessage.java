...
public class DescribeEventSubscriptionsMessage {
  ...
  public DescribeEventSubscriptionsMessage subscriptionName(@javax.annotation.Nullable String subscriptionName) {
  ...
  public DescribeEventSubscriptionsMessage filters(@javax.annotation.Nullable List<Filter> filters) {
    this.filters = filters;
    return this;
  }

  public DescribeEventSubscriptionsMessage addFiltersItem(Filter filtersItem) {
  ...
  public DescribeEventSubscriptionsMessage maxRecords(@javax.annotation.Nullable Integer maxRecords) {
  ...
  public DescribeEventSubscriptionsMessage marker(@javax.annotation.Nullable String marker) {
    this.marker = marker;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("SubscriptionName", "Filters", "MaxRecords", "Marker"));
