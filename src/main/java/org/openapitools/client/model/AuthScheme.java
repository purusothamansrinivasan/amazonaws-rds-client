 ...
 */
@JsonAdapter(AuthScheme.Adapter.class)
public enum AuthScheme {
  ...
  public static AuthScheme fromValue(String value) {
    for (AuthScheme b : AuthScheme.values()) {
  ...
  public static class Adapter extends TypeAdapter<AuthScheme> {
    @Override
    public void write(final JsonWriter jsonWriter, final AuthScheme enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AuthScheme read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AuthScheme.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    AuthScheme.fromValue(value);
  }
}
