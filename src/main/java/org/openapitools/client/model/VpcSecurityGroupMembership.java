...
public class VpcSecurityGroupMembership {
  ...
  public VpcSecurityGroupMembership vpcSecurityGroupId(@javax.annotation.Nullable String vpcSecurityGroupId) {
  ...
  public void setVpcSecurityGroupId(@javax.annotation.Nullable String vpcSecurityGroupId) {
    this.vpcSecurityGroupId = vpcSecurityGroupId;
  }


  public VpcSecurityGroupMembership status(@javax.annotation.Nullable String status) {
    this.status = status;
    return this;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("VpcSecurityGroupId", "Status"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("VpcSecurityGroupId") != null && !jsonObj.get("VpcSecurityGroupId").isJsonNull()) && !jsonObj.get("VpcSecurityGroupId").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `VpcSecurityGroupId` to be a primitive type in the JSON string but got `%s`", jsonObj.get("VpcSecurityGroupId").toString()));
      }
