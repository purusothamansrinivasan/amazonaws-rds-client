...
/**
 * Gets or Sets IAMAuthMode
 */
@JsonAdapter(IAMAuthMode.Adapter.class)
public enum IAMAuthMode {
  ...
  public static IAMAuthMode fromValue(String value) {
    for (IAMAuthMode b : IAMAuthMode.values()) {
  ...
  public static class Adapter extends TypeAdapter<IAMAuthMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final IAMAuthMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public IAMAuthMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return IAMAuthMode.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    IAMAuthMode.fromValue(value);
  }
}
