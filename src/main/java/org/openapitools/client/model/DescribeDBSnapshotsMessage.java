...
public class DescribeDBSnapshotsMessage {
  ...
  public DescribeDBSnapshotsMessage dbInstanceIdentifier(@javax.annotation.Nullable String dbInstanceIdentifier) {
  ...
  public DescribeDBSnapshotsMessage dbSnapshotIdentifier(@javax.annotation.Nullable String dbSnapshotIdentifier) {
  ...
  public DescribeDBSnapshotsMessage snapshotType(@javax.annotation.Nullable String snapshotType) {
  ...
  public DescribeDBSnapshotsMessage filters(@javax.annotation.Nullable List<Filter> filters) {
    this.filters = filters;
    return this;
  }

  public DescribeDBSnapshotsMessage addFiltersItem(Filter filtersItem) {
  ...
  public DescribeDBSnapshotsMessage maxRecords(@javax.annotation.Nullable Integer maxRecords) {
  ...
  public DescribeDBSnapshotsMessage marker(@javax.annotation.Nullable String marker) {
    this.marker = marker;
    return this;
  }
  ...
  public DescribeDBSnapshotsMessage includeShared(@javax.annotation.Nullable Boolean includeShared) {
  ...
  public DescribeDBSnapshotsMessage includePublic(@javax.annotation.Nullable Boolean includePublic) {
  ...
  public DescribeDBSnapshotsMessage dbiResourceId(@javax.annotation.Nullable String dbiResourceId) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeDBSnapshotsMessage describeDBSnapshotsMessage = (DescribeDBSnapshotsMessage) o;
    return Objects.equals(this.dbInstanceIdentifier, describeDBSnapshotsMessage.dbInstanceIdentifier) &&
        Objects.equals(this.dbSnapshotIdentifier, describeDBSnapshotsMessage.dbSnapshotIdentifier) &&
        Objects.equals(this.snapshotType, describeDBSnapshotsMessage.snapshotType) &&
        Objects.equals(this.filters, describeDBSnapshotsMessage.filters) &&
        Objects.equals(this.maxRecords, describeDBSnapshotsMessage.maxRecords) &&
        Objects.equals(this.marker, describeDBSnapshotsMessage.marker) &&
        Objects.equals(this.includeShared, describeDBSnapshotsMessage.includeShared) &&
        Objects.equals(this.includePublic, describeDBSnapshotsMessage.includePublic) &&
        Objects.equals(this.dbiResourceId, describeDBSnapshotsMessage.dbiResourceId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dbInstanceIdentifier, dbSnapshotIdentifier, snapshotType, filters, maxRecords, marker, includeShared, includePublic, dbiResourceId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeDBSnapshotsMessage {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("DBInstanceIdentifier", "DBSnapshotIdentifier", "SnapshotType", "Filters", "MaxRecords", "Marker", "IncludeShared", "IncludePublic", "DbiResourceId"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeDBSnapshotsMessage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeDBSnapshotsMessage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeDBSnapshotsMessage is not found in the empty JSON string", DescribeDBSnapshotsMessage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeDBSnapshotsMessage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeDBSnapshotsMessage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeDBSnapshotsMessage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeDBSnapshotsMessage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeDBSnapshotsMessage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeDBSnapshotsMessage.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeDBSnapshotsMessage>() {
           @Override
           public void write(JsonWriter out, DescribeDBSnapshotsMessage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeDBSnapshotsMessage read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeDBSnapshotsMessage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeDBSnapshotsMessage
   * @throws IOException if the JSON string is invalid with respect to DescribeDBSnapshotsMessage
   */
  public static DescribeDBSnapshotsMessage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeDBSnapshotsMessage.class);
  }

  /**
   * Convert an instance of DescribeDBSnapshotsMessage to an JSON string
   *
   * @return JSON string
   */
