...
public class ResetDBParameterGroupMessage {
  ...
  public ResetDBParameterGroupMessage dbParameterGroupName(@javax.annotation.Nonnull String dbParameterGroupName) {
  ...
  public ResetDBParameterGroupMessage resetAllParameters(@javax.annotation.Nullable Boolean resetAllParameters) {
  ...
  public ResetDBParameterGroupMessage parameters(@javax.annotation.Nullable List<Parameter> parameters) {
    this.parameters = parameters;
    return this;
  }

  public ResetDBParameterGroupMessage addParametersItem(Parameter parametersItem) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("DBParameterGroupName", "ResetAllParameters", "Parameters"));
