...
/**
 * Gets or Sets EngineFamily
 */
@JsonAdapter(EngineFamily.Adapter.class)
public enum EngineFamily {
  ...
  public static EngineFamily fromValue(String value) {
    for (EngineFamily b : EngineFamily.values()) {
  ...
  public static class Adapter extends TypeAdapter<EngineFamily> {
    @Override
    public void write(final JsonWriter jsonWriter, final EngineFamily enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public EngineFamily read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return EngineFamily.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    EngineFamily.fromValue(value);
  }
}
