...
public class DescribeDBProxyTargetsResponse {
  ...
  public DescribeDBProxyTargetsResponse targets(@javax.annotation.Nullable List<DBProxyTarget> targets) {
    this.targets = targets;
    return this;
  }

  public DescribeDBProxyTargetsResponse addTargetsItem(DBProxyTarget targetsItem) {
  ...
  public void setTargets(@javax.annotation.Nullable List<DBProxyTarget> targets) {
    this.targets = targets;
  }


  public DescribeDBProxyTargetsResponse marker(@javax.annotation.Nullable String marker) {
    this.marker = marker;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DescribeDBProxyTargetsResponse describeDBProxyTargetsResponse = (DescribeDBProxyTargetsResponse) o;
    return Objects.equals(this.targets, describeDBProxyTargetsResponse.targets) &&
        Objects.equals(this.marker, describeDBProxyTargetsResponse.marker);
  }

  @Override
  public int hashCode() {
    return Objects.hash(targets, marker);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeDBProxyTargetsResponse {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("Targets", "Marker"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeDBProxyTargetsResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeDBProxyTargetsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeDBProxyTargetsResponse is not found in the empty JSON string", DescribeDBProxyTargetsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeDBProxyTargetsResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeDBProxyTargetsResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("Targets") != null && !jsonObj.get("Targets").isJsonNull()) {
        ...
        if (jsonArraytargets != null) {
          ...
          for (int i = 0; i < jsonArraytargets.size(); i++) {
            DBProxyTarget.validateJsonElement(jsonArraytargets.get(i));
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeDBProxyTargetsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeDBProxyTargetsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeDBProxyTargetsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeDBProxyTargetsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeDBProxyTargetsResponse>() {
           @Override
           public void write(JsonWriter out, DescribeDBProxyTargetsResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeDBProxyTargetsResponse read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeDBProxyTargetsResponse given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeDBProxyTargetsResponse
   * @throws IOException if the JSON string is invalid with respect to DescribeDBProxyTargetsResponse
   */
  public static DescribeDBProxyTargetsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeDBProxyTargetsResponse.class);
  }

  /**
   * Convert an instance of DescribeDBProxyTargetsResponse to an JSON string
   *
   * @return JSON string
   */
