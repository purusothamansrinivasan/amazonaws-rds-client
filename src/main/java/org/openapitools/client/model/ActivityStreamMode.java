...
/**
 * Gets or Sets ActivityStreamMode
 */
@JsonAdapter(ActivityStreamMode.Adapter.class)
public enum ActivityStreamMode {
  ...
  ActivityStreamMode(String value) {
    this.value = value;
  }
  ...
  public static ActivityStreamMode fromValue(String value) {
    for (ActivityStreamMode b : ActivityStreamMode.values()) {
  ...
  public static class Adapter extends TypeAdapter<ActivityStreamMode> {
    @Override
    public void write(final JsonWriter jsonWriter, final ActivityStreamMode enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ActivityStreamMode read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ActivityStreamMode.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ActivityStreamMode.fromValue(value);
  }
}
