...
public class TagListMessage {
  ...
  public TagListMessage tagList(@javax.annotation.Nullable List<Tag> tagList) {
    this.tagList = tagList;
    return this;
  }

  public TagListMessage addTagListItem(Tag tagListItem) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("TagList"));
