...
public class DBSnapshotAttribute {
  ...
  public DBSnapshotAttribute attributeName(@javax.annotation.Nullable String attributeName) {
  ...
  public DBSnapshotAttribute attributeValues(@javax.annotation.Nullable List<String> attributeValues) {
    this.attributeValues = attributeValues;
    return this;
  }

  public DBSnapshotAttribute addAttributeValuesItem(String attributeValuesItem) {
  ...
  public boolean equals(Object o) {
    ...
    DBSnapshotAttribute dbSnapshotAttribute = (DBSnapshotAttribute) o;
    return Objects.equals(this.attributeName, dbSnapshotAttribute.attributeName) &&
        Objects.equals(this.attributeValues, dbSnapshotAttribute.attributeValues);
  }
  ...
  public String toString() {
    ...
    sb.append("class DBSnapshotAttribute {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DBSnapshotAttribute
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DBSnapshotAttribute.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DBSnapshotAttribute is not found in the empty JSON string", DBSnapshotAttribute.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DBSnapshotAttribute.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DBSnapshotAttribute` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DBSnapshotAttribute.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DBSnapshotAttribute' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DBSnapshotAttribute> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DBSnapshotAttribute.class));

       return (TypeAdapter<T>) new TypeAdapter<DBSnapshotAttribute>() {
           @Override
           public void write(JsonWriter out, DBSnapshotAttribute value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DBSnapshotAttribute read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DBSnapshotAttribute given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DBSnapshotAttribute
   * @throws IOException if the JSON string is invalid with respect to DBSnapshotAttribute
   */
  public static DBSnapshotAttribute fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DBSnapshotAttribute.class);
  }

  /**
   * Convert an instance of DBSnapshotAttribute to an JSON string
   *
   * @return JSON string
   */
