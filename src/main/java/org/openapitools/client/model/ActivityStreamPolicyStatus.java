...
/**
 * Gets or Sets ActivityStreamPolicyStatus
 */
@JsonAdapter(ActivityStreamPolicyStatus.Adapter.class)
public enum ActivityStreamPolicyStatus {
  ...
  ActivityStreamPolicyStatus(String value) {
    this.value = value;
  }
  ...
  public static ActivityStreamPolicyStatus fromValue(String value) {
    for (ActivityStreamPolicyStatus b : ActivityStreamPolicyStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<ActivityStreamPolicyStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final ActivityStreamPolicyStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ActivityStreamPolicyStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ActivityStreamPolicyStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ActivityStreamPolicyStatus.fromValue(value);
  }
}
