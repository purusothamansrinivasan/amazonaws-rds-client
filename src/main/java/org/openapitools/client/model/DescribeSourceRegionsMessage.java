...
public class DescribeSourceRegionsMessage {
  ...
  public DescribeSourceRegionsMessage regionName(@javax.annotation.Nullable String regionName) {
  ...
  public DescribeSourceRegionsMessage maxRecords(@javax.annotation.Nullable Integer maxRecords) {
  ...
  public DescribeSourceRegionsMessage marker(@javax.annotation.Nullable String marker) {
    this.marker = marker;
    return this;
  }
  ...
  public DescribeSourceRegionsMessage filters(@javax.annotation.Nullable List<Filter> filters) {
    this.filters = filters;
    return this;
  }

  public DescribeSourceRegionsMessage addFiltersItem(Filter filtersItem) {
  ...
  public boolean equals(Object o) {
    ...
    DescribeSourceRegionsMessage describeSourceRegionsMessage = (DescribeSourceRegionsMessage) o;
    return Objects.equals(this.regionName, describeSourceRegionsMessage.regionName) &&
        Objects.equals(this.maxRecords, describeSourceRegionsMessage.maxRecords) &&
        Objects.equals(this.marker, describeSourceRegionsMessage.marker) &&
        Objects.equals(this.filters, describeSourceRegionsMessage.filters);
  }

  @Override
  public int hashCode() {
    return Objects.hash(regionName, maxRecords, marker, filters);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DescribeSourceRegionsMessage {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("RegionName", "MaxRecords", "Marker", "Filters"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to DescribeSourceRegionsMessage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DescribeSourceRegionsMessage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DescribeSourceRegionsMessage is not found in the empty JSON string", DescribeSourceRegionsMessage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DescribeSourceRegionsMessage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DescribeSourceRegionsMessage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DescribeSourceRegionsMessage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DescribeSourceRegionsMessage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DescribeSourceRegionsMessage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DescribeSourceRegionsMessage.class));

       return (TypeAdapter<T>) new TypeAdapter<DescribeSourceRegionsMessage>() {
           @Override
           public void write(JsonWriter out, DescribeSourceRegionsMessage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DescribeSourceRegionsMessage read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DescribeSourceRegionsMessage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DescribeSourceRegionsMessage
   * @throws IOException if the JSON string is invalid with respect to DescribeSourceRegionsMessage
   */
  public static DescribeSourceRegionsMessage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DescribeSourceRegionsMessage.class);
  }

  /**
   * Convert an instance of DescribeSourceRegionsMessage to an JSON string
   *
   * @return JSON string
   */
