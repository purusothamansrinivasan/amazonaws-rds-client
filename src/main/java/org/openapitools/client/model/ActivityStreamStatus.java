...
/**
 * Gets or Sets ActivityStreamStatus
 */
@JsonAdapter(ActivityStreamStatus.Adapter.class)
public enum ActivityStreamStatus {
  ...
  ActivityStreamStatus(String value) {
    this.value = value;
  }
  ...
  public static ActivityStreamStatus fromValue(String value) {
    for (ActivityStreamStatus b : ActivityStreamStatus.values()) {
  ...
  public static class Adapter extends TypeAdapter<ActivityStreamStatus> {
    @Override
    public void write(final JsonWriter jsonWriter, final ActivityStreamStatus enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public ActivityStreamStatus read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return ActivityStreamStatus.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    ActivityStreamStatus.fromValue(value);
  }
}
