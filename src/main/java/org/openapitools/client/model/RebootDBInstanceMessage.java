...
public class RebootDBInstanceMessage {
  ...
  public RebootDBInstanceMessage dbInstanceIdentifier(@javax.annotation.Nonnull String dbInstanceIdentifier) {
  ...
  public RebootDBInstanceMessage forceFailover(@javax.annotation.Nullable Boolean forceFailover) {
  ...
  public void setForceFailover(@javax.annotation.Nullable Boolean forceFailover) {
    this.forceFailover = forceFailover;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("DBInstanceIdentifier", "ForceFailover"));
