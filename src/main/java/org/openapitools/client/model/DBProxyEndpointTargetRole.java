...
/**
 * Gets or Sets DBProxyEndpointTargetRole
 */
@JsonAdapter(DBProxyEndpointTargetRole.Adapter.class)
public enum DBProxyEndpointTargetRole {
  ...
  public static DBProxyEndpointTargetRole fromValue(String value) {
    for (DBProxyEndpointTargetRole b : DBProxyEndpointTargetRole.values()) {
  ...
  public static class Adapter extends TypeAdapter<DBProxyEndpointTargetRole> {
    @Override
    public void write(final JsonWriter jsonWriter, final DBProxyEndpointTargetRole enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public DBProxyEndpointTargetRole read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return DBProxyEndpointTargetRole.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    DBProxyEndpointTargetRole.fromValue(value);
  }
}
